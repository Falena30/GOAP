...
public class enemy_agent_4 : Labourer {
	...
	public override HashSet<KeyValuePair<string,object>> createGoalState () {
		...
		getWorldState ();
		// main goal
		if (myTabrak[0] == false && myTabrak[1] == false && myTabrak[2] == false && myTabrak[3] == true || sembu == true && playerjauhjipong == true && bergerak == true) {
